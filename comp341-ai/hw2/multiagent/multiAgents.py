...
class ReflexAgent(Agent):
    ...
    def getAction(self, gameState):
        ...
        score_values = [self.evaluationFunction(gameState, action) for action in legalMoves]
        bestScore = max(score_values)
        bestIndices = [index for index in range(len(score_values)) if score_values[index] == bestScore]
