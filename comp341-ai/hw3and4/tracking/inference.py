    ...
    def elapseTime(self, gameState):
        ...
        for old_position in self.allPositions:
            ...
            for new_position, probability in new_position_distribution.items():
                new_beliefs[new_position] += probability * self.beliefs[old_position]
...
class ParticleFilter(InferenceModule):
    ...
    def elapseTime(self, gameState):
        ...
        for old_particle in self.particles:
            new_position_distribution = self.getPositionDistribution(gameState, old_particle)
            new_particles.append(new_position_distribution.sample())
    ...
    def elapseTime(self, gameState):
        ...
        for old_particle in self.particles:
            ...
            for i in range(self.numGhosts):
                ...
                new_particle[i] = new_position_distribution.sample()
